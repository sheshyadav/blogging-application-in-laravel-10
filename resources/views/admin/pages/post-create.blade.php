...
<script>
 CKEDITOR.plugins.add('insertCodeBlock', {
        icons: 'code', // you can add your own icon
        init: function (editor) {
            editor.addCommand('insertCode', {
                exec: function (editor) {
                    const codeTemplate = '<pre class="prettyprint">\n// Your code here\n</pre>';
                    editor.insertHtml(codeTemplate);
                }
            });

            editor.ui.addButton('InsertCodeBlock', {
                label: 'Insert Code Block',
                command: 'insertCode',
                toolbar: 'insert',
                icon: 'https://cdn-icons-png.flaticon.com/512/1828/1828911.png' // or use a custom one
            });
        }
    });
