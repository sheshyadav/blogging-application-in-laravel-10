...
<html lang="en">
    <head>
        ...
        <link rel="shortcut icon" type="image/x-icon" href="<?php echo e(asset('assets/images/softwala/icon.png')); ?>" />
        <!-- 16x16 32x32 48x48 -->
        <!-- End: Favicons -->
...
<?php /**PATH D:\laragon\www\softwala.com\resources\views/admin/app.blade.php ENDPATH**/ ?>